...
const initialState = {
  ...
  blocs: [
      ...
      evaluations: [
        {
          ...
          critere:
            "Pertinence du découpage - Le découpage correspond à la maquette graphique - Les textes, images, sons et vidéos sont placés - Le schéma d’ensemble est cohérent - Les contenus de chaque page sont détaillés",
          note: 0,
          max: 5,
          checkboxes: [
        ...
        },
        {
          ...
          critere:
            "Cohérence du menu de navigation - Le menu de navigation intègre l’ensemble des pages - L’ergonomie de l’ensemble est assurée - Les effets attendus sont intégrés",
          note: 0,
          max: 5,
          checkboxes: [
    ...
    },
    {
      ...
      description:
        "Évaluation individuelle dans le cadre d’une situation professionnelle reconstituée. Évaluation sur un cas pratique donnant lieu à projet (écrit), portant sur la réalisation d’un site web ou d’une application. Après la présentation, un entretien avec un membre du jury, qui pose toutes les questions permettant de mesurer précisément l’étendue des compétences acquises.",
      evaluations: [
        {
          id: 0,
          competence:
            "Importer les polices de caractères en cohérence avec les maquettes graphiques. Aérer et mettre en valeur le texte au travers d’éléments typographiques, afin d’apporter le maximum de clarté pour les utilisateurs",
          critere:
            "Qualité de la mise en page - Les polices de caractère correspondent aux maquettes graphiques - La mise en valeur du texte est adaptée aux besoins des utilisateurs",
          note: 0,
          max: 5,
          checkboxes: [
        ...
        },
        {
          id: 2,
          competence:
            "Programmer les effets graphiques , en vue d’optimiser l’expérience utilisateur. Réaliser l’animation, la transition et la transformation 2D.",
      ...
      evaluations: [
        {
          id: 0,
          competence:
            "Coder la partie front pour mettre l’application en conformité avec les recommandations W3C. (World Wide Web Consortium) Recenser les problèmes éventuels d’accessibilité selon lesdifférents types d’utilisateurs en vue de proposer des améliorations.",
        ...
        },
        {
          id: 1,
          competence:
            "Traduire les principes du référencement dans le code des pages de l’application ou du site, afin d’optimiser le résultat sur différents moteurs de recherche.",
        ...
        },
        {
          id: 3,
          competence:
            "Utiliser Media Queries pour la modulation des règles CSS. Recenser les difficultés d’accès et de rendu utilisateur en fonction des différents terminaux, en vue de proposer des améliorations.",
      ...
      evaluations: [
        {
          id: 0,
          competence:
            "Gérer les sessions, valider et filtrer les données saisies en fonction des règles et contraintes de sécurité, en vue de mémoriser les données ou les actions d’un utilisateur de manière persistante.",
          critere:
            "Agilité de la programmation - Les fonctions avancées de développement back sont connues et bien utilisées - Les contraintes de sécurité sont prises en comptes et les solutions proposées sont correctes - Le langage JavaScript est maîtrisé",
          note: 0,
          max: 5,
          checkboxes: [
        ...
        },
        {
          ...
          critere:
            "Agilité de la programmation - Les contraintes de sécurité sont prises en comptes et les solutions proposées sont correctes - Le langage JavaScript est maîtrisé",
          note: 0,
          max: 5,
          checkboxes: [
        ...
        },
        {
          id: 2,
          competence:
            "Manipuler une page en vue d’optimiser l’expérience utilisateur. Simplifier l'écriture du code en langage JavaScript (ex JQuery)",
      ...
      evaluations: [
        {
          ...
          note: 0,
          max: 5,
          checkboxes: [{ id: 1, name: "UML", checked: false }],
          comment: "",
        },
        {
          id: 1,
          ...
          critere:
            "- La structure de la base de données est cohérente - La désignation des tables et des colonnes est rigoureuse - Les relations entre les tables sont logiques",
          note: 0,
          max: 5,
          checkboxes: [
        ...
        },
        {
          ...
          critere:
            "Efficacité des requêtes et des mises à jour - Les langages utilisés sont maîtrisées - Les contraintes de sécurité sont prises en comptes et les solutions proposées sont correctes - Les données sont traitées avec aisance et rigueur",
          note: 0,
          max: 5,
          checkboxes: [{ id: 1, name: "non demander aux etudiants", checked: true }],
          comment: "",
        },
        {
          id: 3,
